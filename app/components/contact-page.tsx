        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            <p className="text-lg mb-8">
              I'm always interested in new opportunities, collaborations, or just a friendly chat. Feel free to reach
              out using the form or through any of the contact methods below.
            </p>
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-zinc-300">zr.davaa@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-zinc-300">+1 (267) 810-5164</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-zinc-300">Farmington Hills, MI (Open to Relocate)</p>
                </div>
              </div>
            </div>

            <div className="bg-zinc-700/50 backdrop-blur-sm rounded-xl p-6">
          ...
          <motion.div
            ...
            className="bg-zinc-700/50 backdrop-blur-sm rounded-xl p-6"
          >
            <h2 className="text-2xl font-bold mb-6">Send Me a Message</h2>

            {submitSuccess && (
              <div className="bg-emerald-500/20 border border-emerald-500 text-emerald-400 rounded-lg p-4 mb-6">
                Thanks for reaching out! I’ll get back to you as soon as I can — usually within 24 hours.
              </div>
            )}
